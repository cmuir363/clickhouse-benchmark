...
INSERT INTO default.generated_timestamps
SELECT
    now() - INTERVAL number MILLISECOND AS timestamp,
    rand() % (SELECT count(*) FROM default.iot_metadata)
FROM
...
INSERT INTO default.iot_measurements_raw_temp
SELECT
    ownerId,
    factoryId,
    sensorId,
